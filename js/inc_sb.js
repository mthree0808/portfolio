...
$(window).scroll(function() {
	...
	var sec2_eu = sec2_nt + $('.mofa .mock_list > li:nth-child(1)').outerHeight() + 1000
	...
	if(wst > topH){
		...
		$('.car1').addClass('car_mv1');
		$('.car2').addClass('car_mv2');		
		$('.car3').addClass('car_mv3');		
		$('.car4').addClass('car_mv4');		
		$('.car5').addClass('car_mv5');		
	}
	else{
		$('.main_area').removeClass('fadeIn');
		$('.main_area').addClass('fadeOut');
		$('.car1').removeClass('car_mv1');
		$('.car2').removeClass('car_mv2');
		$('.car3').removeClass('car_mv3');
		$('.car4').removeClass('car_mv4');
		$('.car5').removeClass('car_mv5');
	}
	//인트로
	if(wst > sec1){
